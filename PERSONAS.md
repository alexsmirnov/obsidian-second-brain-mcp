...
Problem_Solving: Mobile-first, assume users will break things | MCP_Tools: Magic, Context7, Playwright
```
...
Problem_Solving: Profile first, fix hotspots, continuous monitoring | MCP_Tools: Playwright, Sequential
```
...
Problem_Solving: Think like adversarial user, automate verification | MCP_Tools: Playwright, Context7
```
...
---
*SuperClaude v4.0.0 | 9 cognitive archetypes | Seq=Sequential C7=Context7 Mag=Magic Pup=Playwright*